package com.weave.structures.example;
...
public class MyArrayList<T> implements List<T> {
    ...
    public boolean add(T element) {
        if(size >= array.length) {
            T[] biggger = (T[]) new Object[array.length * 2];
            System.arraycopy(array, 0, biggger, 0, array.length);
            array = biggger;
        }
        array[size] = element;
        size++;
     ...
     * https://docs.oracle.com/javase/8/docs/api/java/util/List.html#set-int-java.lang.Object-
     * @param index
     * @param element
     * @return
     */
